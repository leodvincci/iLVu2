...
React.useEffect(()=>{
        ...
        .then(r=>{
            for(const d of r.data.Data){
                // console.log(d)
                // if(d.Mood_Tracker_id !=null){
                //                     // console.log(typeof(d.Mood_Tracker_id),"=>",d.Mood_Tracker_id, " &&& ", typeof (d.App_user_id),"---->",d.App_user_id, " userID: ",userID)
                //
                // }
                if(d.Mood_Tracker_id !== null && d.App_user_id === userID){
